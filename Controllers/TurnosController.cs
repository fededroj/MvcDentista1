...
namespace MvcDentista1.Controllers
{
    public class TurnosController : Controller
    {
        ...
        public TurnosController(MvcDentista1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,CorreoElectronico,FechaTurno,Comentario")] Turno turno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,CorreoElectronico,FechaTurno,Comentario")] Turno turno)
        {
            if (id != turno.Id)
            {
                return NotFound();
